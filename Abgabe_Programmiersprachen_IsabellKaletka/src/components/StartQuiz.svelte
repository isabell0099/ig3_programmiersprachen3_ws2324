  ...
  onMount(() => {
    ...
    images.forEach((img) => {
      ...
      while (!isValidPosition) {
        const randomX =
          Math.floor(Math.random() * (window.innerWidth - 2 * margin)) + margin;
        const randomY =
          Math.floor(Math.random() * (window.innerHeight - 2 * margin)) +
          margin;
...
<div class="background-images">
  ...
  <img
    src="/images/BilderQuiz/Vector-2.png"
    alt="height"
    style="width:106px;height:223px;"
  />
  <img src="/images/BilderQuiz/Vector-3.png" alt="height" />
  <img src="/images/BilderQuiz/Vector-4.png" alt="height" />
  <img
    src="/images/BilderQuiz/Vector-5.png"
    alt="height"
    style="width: 129px;height: 299px;"
  />
